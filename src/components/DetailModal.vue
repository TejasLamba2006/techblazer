...
const emit = defineEmits<{
  (e: 'close'): void
  (e: 'showPerson', person: Participant): void
  (e: 'showProject', project: Project): void
}>()

const activeParticipant = computed(() => {
  return props.activeModalType === 'person' ? props.activeItem as Participant : null
})

const activeProject = computed(() => {
  return props.activeModalType === 'project' ? props.activeItem as Project : null
})
</script>

<template>
  <Transition name="fade-blur">
    <div v-if="activeModalType" class="detail-modal-overlay" @click.self="emit('close')">
      <!-- Person Detail Modal -->
      <div
